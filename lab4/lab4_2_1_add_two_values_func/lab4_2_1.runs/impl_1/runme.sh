...
HD_PWD='C:/Users/yvvan/Documents/Research/Vivado_Verilog_Tutorial/lab4/lab4_2_1_add_two_values_func/lab4_2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_two_values_func.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_two_values_func.tcl -notrace
