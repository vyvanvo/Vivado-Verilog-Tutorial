...
HD_PWD='C:/Users/yvvan/Documents/Research/Vivado_Verilog_Tutorial/lab4/lab4_2_2/lab4_2_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calc_ones_func.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calc_ones_func.tcl
