...
HD_PWD='C:/Users/yvvan/Documents/Research/Vivado_Verilog_Tutorial/lab4/lab4_2_2/lab4_2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log calc_ones_func.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source calc_ones_func.tcl -notrace
