...
HD_PWD='C:/Users/yvvan/Documents/Research/Vivado_Verilog_Tutorial/lab6/lab6_1_3/lab6_1_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_register_delay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_register_delay.tcl -notrace
