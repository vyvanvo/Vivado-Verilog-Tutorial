...
set rc [catch {
  ...
  open_checkpoint input_output_dataflow_routed.dcp
  ...
  catch { write_mem_info -force input_output_dataflow.mmi }
  write_bitstream -force input_output_dataflow.bit 
  catch {write_debug_probes -quiet -force input_output_dataflow}
  catch {file copy -force input_output_dataflow.ltx debug_nets.ltx}
