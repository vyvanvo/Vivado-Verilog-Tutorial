...
HD_PWD='C:/Users/yvvan/Documents/Research/Vivado_Verilog_Tutorial/lab1/lab1_2_1_input_output_dataflow/lab1_2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log input_output_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source input_output_dataflow.tcl -notrace
