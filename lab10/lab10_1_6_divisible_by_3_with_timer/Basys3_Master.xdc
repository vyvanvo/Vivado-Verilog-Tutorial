...
#set_property PACKAGE_PIN V16 [get_ports {display_num[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {display_num[1]}]
#set_property PACKAGE_PIN W16 [get_ports {display_num[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {display_num[2]}]
#set_property PACKAGE_PIN W17 [get_ports {display_num[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {display_num[3]}]
...
set_property PACKAGE_PIN W18 [get_ports {num_of_ones[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_of_ones[0]}]
set_property PACKAGE_PIN U15 [get_ports {num_of_ones[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_of_ones[1]}]
set_property PACKAGE_PIN U14 [get_ports {num_of_ones[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num_of_ones[2]}]
...
set_property PACKAGE_PIN U18 [get_ports rst]						
	set_property IOSTANDARD LVCMOS33 [get_ports rst]
#set_property PACKAGE_PIN T18 [get_ports ain]						
#	set_property IOSTANDARD LVCMOS33 [get_ports ain]
