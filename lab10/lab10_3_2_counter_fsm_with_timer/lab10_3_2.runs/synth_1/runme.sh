...
HD_PWD='C:/Users/yvvan/Documents/Research/Vivado_Verilog_Tutorial/lab10/lab10_3_2/lab10_3_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_fsm_using_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_fsm_using_ROM.tcl
