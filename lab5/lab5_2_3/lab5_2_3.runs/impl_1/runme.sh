...
HD_PWD='C:/Users/yvvan/Documents/Research/Vivado_Verilog_Tutorial/lab5/lab5_2_3/lab5_2_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log D_flipflop_with_synch_reset.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_flipflop_with_synch_reset.tcl -notrace
