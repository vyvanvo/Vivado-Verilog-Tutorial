...
HD_PWD='C:/Users/yvvan/Documents/Research/Vivado_Verilog_Tutorial/lab5/lab5_1_2/lab5_1_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gated_SR_latch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gated_SR_latch.tcl
